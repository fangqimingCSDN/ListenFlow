...
pathlib.Path('d:/B-Work/PyCharm/2025/speech_proj/scripts/_arch_sec6b.txt').write_text(SEC6B, encoding='utf-8')
print('sec6b len:', len(SEC6B))
print('done')
